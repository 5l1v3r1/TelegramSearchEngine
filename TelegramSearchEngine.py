    ...
    def google(mesaj,google=google):
        try:
            try:
                ...
                ara = " ".join(ara)
                if not ara:bot.reply_to(mesaj,f"Örnek :  /google python3 pdf ")
                else:
